...
<template>
  <div class="header md:hidden sm:hidden xs:hidden lg:block">
    <!-- 顶部内容 -->
    <div class="p-5f">
  ...
  <!-- pc端菜单 -->
  <div class="header-menu md:hidden sm:hidden xs:hidden lg:block">
  ...
  <!-- 移动端菜单图标 -->
  <!-- mobile-menu -->
  <div class="sticky top-0 p-6 bg-white z-999 lg:hidden md:block">
    <img
      style="flex: 1"
      class="menu-icon"
