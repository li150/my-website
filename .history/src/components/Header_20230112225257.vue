...
<template>
  ...
  <!-- 移动端菜单图标 -->
  <!-- mobile-menu -->
  <div class="sticky top-0 p-6 bg-white z-999 lg:hidden xs:block">
    <img class="menu-icon" src="../assets/images/header/menu.png" @click="hanleOpenMenu" />
    <div style="flex: 23; margin-right: 8vw" class="flex flex-center">
      <img class="menu-icon" src="../assets/images/logo.png" />
      <div class="mt-2">{{ $t("header.title") }}</div>
    </div>
  </div>
</template>
